...
const CreateNews = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(`${baseURL}/api/add`, form, {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-y-2">
              ...
              >
                ...
                <option value="ভূ-মণ্ডল">ভূ-মণ্ডল</option>
                ...
                <option value="রাইটার্স-ক্যানভাস">রাইটার্স-ক্যানভাস</option>
              </select>
            </div>
            ...
            {!imagePreview ? (
              ...
              <div className="relative inline-block">
                <img
                  src={imagePreview}
                  alt="Preview"
                  className="h-36 md:h-48 w-auto object-cover rounded-lg border-2 border-[#F7941D]"
                />
                <button
                  type="button"
